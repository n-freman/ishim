...
def wide_search_cv(request):
    if request.POST:
        ...
        if data['position'] and data['sphere']:
            ...
            context.update(get_footer())
            return render(request, 'search/search_cv_results.html', context)
    return render(request, 'search/wide_search_cv.html', get_footer())
...
def wide_search_vacancy(request):
    if request.POST:
        ...
        if data['position'] and data['sphere']:
            ...
            context.update(get_footer())
            return render(request, 'search/search_vacancy_results.html', context)
    return render(request, 'search/wide_search_vacancy.html', get_footer())
...
def search_history_employee(request):
    ...
    return render(request, 'search/search_history_employee.html', context)
...
def search_history_hirer(request):
    ...
    for story in stories:
        print(story.search)
    return render(request, 'search/search_history_hirer.html', context)
