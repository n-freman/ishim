...
def vacancy_create(request):
    if request.POST:
        ...
        return redirect(reverse('my-vacancies-tm'))
    return render(request, 'tm_vacancy/vacancy_create.html')
...
def edit_vacancy(request, id):
    ...
    if request.POST:
        ...
        if new_vacancy_form.is_valid():
            ...
            return redirect('my-vacancy-info-tm', id)
    context = {
        'vacancy': vacancy
    }
    return render(request, 'tm_vacancy/edit.html', context)
...
def my_vacancies(request):
    ...
    return render(request, 'tm_vacancy/my_vac.html', context)


class MyVacancyDetailView(LoginRequiredMixin, UserPassesTestMixin, DetailView):
    model = Vacancy
    template_name = 'tm_vacancy/my_vacancy_detail.html'
...
class VacancyDetailView(LoginRequiredMixin, UserPassesTestMixin, DetailView):
    model = Vacancy
    template_name = 'tm_vacancy/vacancy_detail.html'
...
def chosen_vacancies(request):
    ...
    return render(request, 'tm_vacancy/chosen.html', context)
...
def suitable_vacancies(request, id):
    ...
    return render(request, 'tm_vacancy/suitable_vacancies.html', context)
