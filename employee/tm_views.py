...
def employee_create(request, *args):
        ...
        if u_form.is_valid() and e_form.is_valid() and birth_date:
            ...
            try:
                if User.objects.get(email=request.POST.get('email')):
                    ...
                    return render(request, 'tm_employee/employee_create.html', context)
    ...
    return render(request, 'tm_employee/employee_create.html')
...
def create_cv(request, *args):
    if request.method == 'POST':
        ...
        if not cv_form.is_valid():
            ...
            return redirect(reverse('create-cv-tm'))
...
def edit_cv(request, id):
    ...
    return render(request, 'tm_employee/cv_edit.html', context)
...
def get_contact(request, id):
    ...
    if not contact:
        ...
        contact.delete()
    return redirect(reverse('home-tm'))
...
def my_cv(request):
    ...
    return render(request, 'tm_employee/my_cv.html', context)
...
class MyCVDetailView(LoginRequiredMixin, UserPassesTestMixin, DetailView):
    model = CV
    template_name = 'tm_employee/my_cv_detail.html'
...
class CVDetailView(LoginRequiredMixin, UserPassesTestMixin, DetailView):
    model = CV
    template_name = 'tm_employee/cv_detail.html'
...
def chosen_cvs(request):
    ...
    return render(request, 'tm_employee/chosen.html', context)
...
def suitable_cvs(request, id):
    ...
    return render(request, 'tm_employee/suitable_cvs.html', context)
...
def vacancy_responses(request, id):
    ...
    return render(request, 'tm_employee/', context)
...
def my_responses(request):
    ...
    return render(request, 'tm_employee/my_responses.html', context)